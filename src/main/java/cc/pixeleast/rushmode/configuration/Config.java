...
public class Config extends ConfigManager {
    ...
    public Config(String name) {
        ...
        yml.setComment(GENERAL_TEAM_UPGRADES, """
                List of team upgrades and their tiers
        ...
        yml.setComment(GENERAL_TEAM_EFFECTS, """
                List of team effects and their amplifiers/durations
        ...
        yml.setComment(GENERAL_BED_PROTECTION, """
                The defense layer of the bed
        ...
        yml.setComment(SOUNDS, """
        Manage sound in various situations
